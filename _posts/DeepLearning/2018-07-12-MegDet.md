...
4.  _long mode__의 학습은 조금 더 좋은 성능을 보여줍니다.



첫번째 그림은 실험결과에 대한 내용이며, 두번째 그림은 _long mode_에서 batch size가 16인 모델과 256인 모델의 validation 그래프를 보여줍니다. batch size 256의 _long mode_는 초기 epoch <16까지>에서는 baseline 보다 안좋으나 그 이후에 따라잡게 됩니다.
